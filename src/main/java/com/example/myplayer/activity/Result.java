...
import com.example.myplayer.adapter.MusicListAdapter;
import com.example.myplayer.db.MusicListInfo;
...
//  实现界面的接口
    ...
    public void initListener(){
        mAdapter.setOnMenuClickListener(new MusicListAdapter.OnMenuClickListener() {
            @Override
